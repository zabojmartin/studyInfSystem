<?php
// source: C:\xampp\htdocs\study\sandbox\app/config/config.neon 

class Container_e017b39ce2 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'33_App_Model_StudentRepository',
					'34_App_Model_TeacherRepository',
					'35_App_Model_UserManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Model\StudentRepository' => array(
				1 => array('33_App_Model_StudentRepository'),
			),
			'App\Model\TeacherRepository' => array(
				1 => array('34_App_Model_TeacherRepository'),
			),
			'Nette\Security\IAuthenticator' => array(1 => array('35_App_Model_UserManager')),
			'App\Model\UserManager' => array(1 => array('35_App_Model_UserManager')),
			...
			'App\Presenters\PersonPresenter' => array(array('application.6', 'application.8')),
			'App\Presenters\SignPresenter' => array(array('application.7')),
			'App\Presenters\StudentPresenter' => array(array('application.8')),
			'App\Presenters\TeacherPresenter' => array(array('application.9')),
		...
		'services' => array(
			...
			'33_App_Model_StudentRepository' => 'App\Model\StudentRepository',
			'34_App_Model_TeacherRepository' => 'App\Model\TeacherRepository',
			'35_App_Model_UserManager' => 'App\Model\UserManager',
			...
			'application.8' => 'App\Presenters\StudentPresenter',
			'application.9' => 'App\Presenters\TeacherPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\study\sandbox\app',
			'wwwDir' => 'C:\xampp\htdocs\study\sandbox\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\study\sandbox\app/../temp',
		));
	}
	...
	public function createService__30_App_Model_ExternalTeacherRepository()
	{
		$service = new App\Model\ExternalTeacherRepository($this->getService('database.default.context'), $this->getService('32_App_Model_PersonRepository'),
			$this->getService('34_App_Model_TeacherRepository'), $this->getService('35_App_Model_UserManager'));
		return $service;
	}
	 ...
	 */
	public function createService__33_App_Model_StudentRepository()
	{
		$service = new App\Model\StudentRepository($this->getService('database.default.context'), $this->getService('35_App_Model_UserManager'),
	 ...
	 */
	public function createService__34_App_Model_TeacherRepository()
	{
	...
	{
		$service = new App\Presenters\CoursePresenter($this->getService('database.default.context'), $this->getService('34_App_Model_TeacherRepository'),
	...
	{
		$service = new App\Presenters\StudentPresenter($this->getService('database.default.context'), $this->getService('33_App_Model_StudentRepository'),
	...
	{
		$service = new App\Presenters\TeacherPresenter($this->getService('database.default.context'), $this->getService('34_App_Model_TeacherRepository'),
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\study\sandbox\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\study\sandbox\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\study\sandbox\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_e017b39ce2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\study\sandbox\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('35_App_Model_UserManager'));
...
final class Container_e017b39ce2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e017b39ce2 $container)
	{
